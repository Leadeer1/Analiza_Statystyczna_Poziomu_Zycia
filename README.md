# Analiza_Statystyczna_Poziomu_Zycia
**ANALIZA STATYSTYCZNA POZIOMU ŻYCIA W PODREGIONACH POLSKI (NUTS3) | 11/2025**

**Problem**  
Przeprowadzenie wielowymiarowej oceny poziomu życia i kondycji ekonomicznej 73 podregionów Polski (NUTS3) w oparciu o 20 wskaźników społeczno-ekonomicznych z Banku Danych Lokalnych GUS.
...
**Wynik**  
Udowodnienie wysokiej spójności stosowanych metod statystycznych (korelacja rang = 0,916) oraz empiryczne potwierdzenie trójstopniowej polaryzacji rozwoju przestrzennego Polski.
